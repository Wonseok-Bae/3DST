...
TH1F* threshold_vs_efficiency = new TH1F("threshoold_efficiency","threshoold_efficiency",11,0,1.1);
// }}}
...
// }}}
    ...
    float thres_1=0., thres_09=0., thres_08=0., thres_07=0., thres_06=0., thres_05=0., thres_04=0., thres_03=0., thres_02 = 0.0;
    float thres_01=0., thres_009=0., thres_008=0., thres_007=0., thres_006=0., thres_005=0., thres_004=0., thres_003=0., thres_002 = 0.0;
    float thres_001=0., thres_0009=0., thres_0008=0., thres_0007=0., thres_0006=0., thres_0005=0., thres_0004=0., thres_0003=0., thres_0002 = 0.0;
    float thres_0001=0., thres_00009=0., thres_00008=0., thres_00007=0., thres_00006=0., thres_00005=0., thres_00004=0., thres_00003=0., thres_00002 = 0.0;
    float thres_00001=0., thres_00000 = 0.0;

    float threshold_1=0., threshold_09=0., threshold_08=0., threshold_07=0., threshold_06=0., threshold_05=0., threshold_04=0., threshold_03=0., threshold_02 = 0.0;
    float threshold_01=0., threshold_009=0., threshold_008=0., threshold_007=0., threshold_006=0., threshold_005=0., threshold_004=0., threshold_003=0., threshold_002 = 0.0;
    float threshold_001=0., threshold_0009=0., threshold_0008=0., threshold_0007=0., threshold_0006=0., threshold_0005=0., threshold_0004=0., threshold_0003=0., threshold_0002 = 0.0;
    float threshold_0001=0., threshold_00009=0., threshold_00008=0., threshold_00007=0., threshold_00006=0., threshold_00005=0., threshold_00004=0., threshold_00003=0., threshold_00002 = 0.0;
    float threshold_00001=0., threshold_00000 = 0.0; 
	...
	for (int iTime = 0; iTime < 25; iTime++){
	    ...
	    // Count signal
	    for (auto vec : sig_Neutron_Lvr[iLvr]){ //vec이라는 변수를 만들어서 sig_Neutron_Lvr[1~20]들을 할당시킨다.
		if (iTime == (int) vec.timeWindow) nbSig++;
	            //cout << vec.energyDeposit << endl; //이거 변수-값 잘 뽑히는 지 확인
	            if (vec.energyDeposit > 1.0) thres_1++;  //else {thres_1=0;}//++;
		    if (vec.energyDeposit > 0.9) thres_09++;  //else {thres_09=0;}//++;
		    if (vec.energyDeposit > 0.8) thres_08++;  //else {thres_08=0;}///++;
		    if (vec.energyDeposit > 0.7) thres_07++;  //else {thres_07=0;}///++;
		    if (vec.energyDeposit > 0.6) thres_06++;  //else {thres_06=0;}///++;
		    if (vec.energyDeposit > 0.5) thres_05++;  //else {thres_05=0;}///++;
 		    if (vec.energyDeposit > 0.4) thres_04++;  //else {thres_04=0;}///++;
		    if (vec.energyDeposit > 0.3) thres_03++;  //else {thres_03=0;}///++;
		    if (vec.energyDeposit > 0.2) thres_02++;  //else {thres_02=0;}///++;
		    if (vec.energyDeposit > 0.1) thres_01++;  //else {thres_01=0;}///++;
		    if (vec.energyDeposit > 0.09) thres_009++;//=1;  else {thres_009=0;}///++;
		    if (vec.energyDeposit > 0.08) thres_008++;//=1;  else {thres_008=0;}///++;
		    if (vec.energyDeposit > 0.07) thres_007++;//=1;  else {thres_007=0;}///++;
		    if (vec.energyDeposit > 0.06) thres_006++;//=1;  else {thres_006=0;}///++;
		    if (vec.energyDeposit > 0.05) thres_005++;//=1;  else {thres_005=0;}///++;
		    if (vec.energyDeposit > 0.04) thres_004++;//=1;  else {thres_004=0;}///++;
		    if (vec.energyDeposit > 0.03) thres_003++;//=1;  else {thres_003=0;}///++;
		    if (vec.energyDeposit > 0.02) thres_002++;//=1;  else {thres_002=0;}///++;
		    if (vec.energyDeposit > 0.01) thres_001++;//=1;  else {thres_001=0;}///++;
                    if (vec.energyDeposit > 0.009) thres_0009++;//=1;  else {thres_0009=0;}///++;
                    if (vec.energyDeposit > 0.008) thres_0008++;//=1;  else {thres_0008=0;}///++;
                    if (vec.energyDeposit > 0.007) thres_0007++;//=1;  else {thres_0007=0;}///++;
                    if (vec.energyDeposit > 0.006) thres_0006++;//=1;  else {thres_0006=0;}///++;
                    if (vec.energyDeposit > 0.005) thres_0005++;//=1;  else {thres_0005=0;}///++;
                    if (vec.energyDeposit > 0.004) thres_0004++;//=1;  else {thres_0004=0;}///++;
                    if (vec.energyDeposit > 0.003) thres_0003++;//=1;  else {thres_0003=0;}///++;
                    if (vec.energyDeposit > 0.002) thres_0002++;//=1;  else {thres_0002=0;}///++;
                    if (vec.energyDeposit > 0.001) thres_0001++;//=1;  else {thres_0001=0;}///++;
                    if (vec.energyDeposit > 0.0009) thres_00009++;//=1;  else {thres_00009=0;}///++;
                    if (vec.energyDeposit > 0.0008) thres_00008++;//=1;  else {thres_00008=0;}///++;
                    if (vec.energyDeposit > 0.0007) thres_00007++;//=1;  else {thres_00007=0;}///++;
                    if (vec.energyDeposit > 0.0006) thres_00006++;//=1;  else {thres_00006=0;}///++;
                    if (vec.energyDeposit > 0.0005) thres_00005++;//=1;  else {thres_00005=0;}///++;
                    if (vec.energyDeposit > 0.0004) thres_00004++;//=1;  else {thres_00004=0;}///++;
                    if (vec.energyDeposit > 0.0003) thres_00003++;//=1;  else {thres_00003=0;}///++;
                    if (vec.energyDeposit > 0.0002) thres_00002++;//=1;  else {thres_00002=0;}///++;
                    if (vec.energyDeposit > 0.0001) thres_00001++;//=1;  else {thres_00001=0;}///++;
		    if (vec.energyDeposit > 0.0) thres_00000++;//=1;  else {thres_00000=0;}///++;
	   	    //cout<< "No purity cut : "<< thres_1 << "  " << thres_09 << "  " << thres_08  <<"  "<<  thres_07  << "  " <<  thres_06  << "  " << thres_05 << "  " << thres_04 << "  " << thres_03 << "  " << thres_02 << "  " << thres_01 << "  "<< thres_009 << "  " << thres_008  <<"  "<<  thres_007  << "  " <<  thres_006  << "  " << thres_005 << "  " << thres_004 << "  " << thres_003 << "  " << thres_002 << "  " << thres_001 << "  "<< thres_0009 << "  " << thres_0008  << "  "<<  thres_0007  << "  " <<  thres_0006  << "  " << thres_0005 << "  " << thres_0004 << "  " << thres_0003 << "  " << thres_0002 << "  " << thres_0001 << "  "<< thres_00009 << "  " << thres_00008  <<"  " <<  thres_00007  << "  " <<  thres_00006  << "  " << thres_00005 << "  " << thres_00004 << "  " << thres_00003 << "  " << thres_00002 << "  " << thres_00001 << endl;
	    }
		...
		threshold_1 += thres_1;
		threshold_09 += thres_09;
		threshold_08 += thres_08;
		threshold_07 += thres_07;
		threshold_06 += thres_06;
		threshold_05 += thres_05;
		threshold_04 += thres_04;
		threshold_03 += thres_03;
		threshold_02 += thres_02;
		threshold_01 += thres_01;
   		threshold_009 += thres_009;
                threshold_008 += thres_008;
                threshold_007 += thres_007;
                threshold_006 += thres_006;
                threshold_005 += thres_005;
                threshold_004 += thres_004;
                threshold_003 += thres_003;
                threshold_002 += thres_002;
                threshold_001 += thres_001;
		threshold_0009 += thres_0009;
                threshold_0008 += thres_0008;
                threshold_0007 += thres_0007;
                threshold_0006 += thres_0006;
                threshold_0005 += thres_0005;
                threshold_0004 += thres_0004;
                threshold_0003 += thres_0003;
                threshold_0002 += thres_0002;
                threshold_0001 += thres_0001;
		threshold_00009 += thres_00009;
                threshold_00008 += thres_00008;
	        threshold_00007 += thres_00007;
                threshold_00006 += thres_00006;
                threshold_00005 += thres_00005;
                threshold_00004 += thres_00004;
                threshold_00003 += thres_00003;
                threshold_00002 += thres_00002;
                threshold_00001 += thres_00001;
		threshold_00000 += thres_00000;		
                cout<< "0.9 purity cut : "<< threshold_1 << "  " << threshold_09 << "  " << threshold_08  <<"  "<<  threshold_07  << "  " <<  threshold_06  << "  " << threshold_05 << "  " << threshold_04 << "  " << threshold_03 << "  " << threshold_02 << "  " << threshold_01 << "  "<< threshold_009 << "  " << threshold_008  <<"  "<<  threshold_007  << "  " <<  threshold_006  << "  " << threshold_005 << "  " << threshold_004 << "  " << threshold_003 << "  " << threshold_002 << "  " << threshold_001 << "  "<< threshold_0009 << "  " << threshold_0008  << "  "<<  threshold_0007  << "  " <<  threshold_0006  << "  " << threshold_0005 << "  " << threshold_0004 << "  " << threshold_0003 << "  " << threshold_0002 << "  " << threshold_0001 << "  "<< threshold_00009 << "  " << threshold_00008  <<"  " <<  threshold_00007  << "  " <<  threshold_00006  << "  " << threshold_00005 << "  " << threshold_00004 << "  " << threshold_00003 << "  " << threshold_00002 << "  " << threshold_00001 << endl;
		}
		thres_1=0., thres_09=0., thres_08=0., thres_07=0., thres_06=0., thres_05=0., thres_04=0., thres_03=0., thres_02 = 0.0;
    		thres_01=0., thres_009=0., thres_008=0., thres_007=0., thres_006=0., thres_005=0., thres_004=0., thres_003=0., thres_002 = 0.0;
    		thres_001=0., thres_0009=0., thres_0008=0., thres_0007=0., thres_0006=0., thres_0005=0., thres_0004=0., thres_0003=0., thres_0002 = 0.0;
    		thres_0001=0., thres_00009=0., thres_00008=0., thres_00007=0., thres_00006=0., thres_00005=0., thres_00004=0., thres_00003=0., thres_00002 = 0.0;
    		thres_00001=0., thres_00000 = 0.0;
	...
	for (int iTime = 0; iTime < 25; iTime++){
     ...
     //뜨레시홀드 이피션시 1차원 그래프
     threshold_vs_efficiency->SetBinContent(1,threshold_00000/threshold_00000);
     /*threshold_vs_efficiency->SetBinContent(2,threshold_00001/threshold_00000);
     threshold_vs_efficiency->SetBinContent(3,threshold_00002/threshold_00000);
     threshold_vs_efficiency->SetBinContent(4,threshold_00003/threshold_00000);
     threshold_vs_efficiency->SetBinContent(5,threshold_00004/threshold_00000);
     threshold_vs_efficiency->SetBinContent(6,threshold_00005/threshold_00000);
     threshold_vs_efficiency->SetBinContent(7,threshold_00006/threshold_00000);
     threshold_vs_efficiency->SetBinContent(8,threshold_00007/threshold_00000);
     threshold_vs_efficiency->SetBinContent(9,threshold_00008/threshold_00000);
     threshold_vs_efficiency->SetBinContent(10,threshold_00009/threshold_00000);
     threshold_vs_efficiency->SetBinContent(11,threshold_0001/threshold_00000);
     threshold_vs_efficiency->SetBinContent(12,threshold_0002/threshold_00000);
     threshold_vs_efficiency->SetBinContent(13,threshold_0003/threshold_00000);
     threshold_vs_efficiency->SetBinContent(14,threshold_0004/threshold_00000);
     threshold_vs_efficiency->SetBinContent(15,threshold_0005/threshold_00000);
     threshold_vs_efficiency->SetBinContent(16,threshold_0006/threshold_00000);
     threshold_vs_efficiency->SetBinContent(17,threshold_0007/threshold_00000);
     threshold_vs_efficiency->SetBinContent(18,threshold_0008/threshold_00000);
     threshold_vs_efficiency->SetBinContent(19,threshold_0009/threshold_00000);
     threshold_vs_efficiency->SetBinContent(20,threshold_001/threshold_00000);
     threshold_vs_efficiency->SetBinContent(21,threshold_002/threshold_00000);
     threshold_vs_efficiency->SetBinContent(22,threshold_003/threshold_00000);
     threshold_vs_efficiency->SetBinContent(23,threshold_004/threshold_00000);
     threshold_vs_efficiency->SetBinContent(24,threshold_005/threshold_00000);
     threshold_vs_efficiency->SetBinContent(25,threshold_006/threshold_00000);
     threshold_vs_efficiency->SetBinContent(26,threshold_007/threshold_00000);
     threshold_vs_efficiency->SetBinContent(27,threshold_008/threshold_00000);
     threshold_vs_efficiency->SetBinContent(28,threshold_009/threshold_00000);*/
     threshold_vs_efficiency->SetBinContent(2,threshold_01/threshold_00000);
     threshold_vs_efficiency->SetBinContent(3,threshold_02/threshold_00000);
     threshold_vs_efficiency->SetBinContent(4,threshold_03/threshold_00000);
     threshold_vs_efficiency->SetBinContent(5,threshold_04/threshold_00000);
     threshold_vs_efficiency->SetBinContent(6,threshold_05/threshold_00000);
     threshold_vs_efficiency->SetBinContent(7,threshold_06/threshold_00000);
     threshold_vs_efficiency->SetBinContent(8,threshold_07/threshold_00000);
     threshold_vs_efficiency->SetBinContent(9,threshold_08/threshold_00000);
     threshold_vs_efficiency->SetBinContent(10,threshold_09/threshold_00000);
     threshold_vs_efficiency->SetBinContent(11,threshold_1/threshold_00000);
