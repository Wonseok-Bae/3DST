...
//wonseok
TH1F * distance_pideath_neutronstart = new TH1F("distance_pideath_neutronstart","distance_PrimaryFSParticleDeath_NeutronStart(0pi1p); distance (cm)",50,0,500);
TH2F * distnace&Energy_pideath_neutronstart = new TH2F("distnace&Energy_pideath_neutronstart", "PrimaryFSParticleDeath_NeutronStart(0pi1p); distance (cm); Energy (MeV)",50,0,500,50,0,1000);
                            ...
                            if(t_neutronStartingPointX[n_neutronHit] == t_piDeath[0] && t_neutronStartingPointY[n_neutronHit] == t_piDeath[1] && t_neutronStartingPointZ[n_neutronHit] == t_piDeath[2] )
                            ...
                            else
                                {
                                 ...
                                 cout<<distance_pideath_nstart<<endl;
                                    ...
                                    distnace&Energy_pideath_neutronstart
